...
alias flutter-clean='flutter-update-flutterfire; flutter-update-firebase; flutter clean && flutter pub upgrade && flutter pub outdated && flutter pub upgrade --major-versions; flutter-dart-fix'
...
alias flutter-update-firebase='cd firebase/functions && sudo npm-check -u && sudo npm ci && cd ../..'
...
alias flutter-firebase-init='firebase login; flutter-update-flutterfire; flutterfire configure;'
alias flutter-firebase-configure='flutterfire configure;'
alias flutter-update-flutterfire='dart pub global activate flutterfire_cli;'
