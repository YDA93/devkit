...
alias flutter-clean='flutter-update-firebase; flutter clean && flutter pub upgrade && flutter pub outdated && flutter pub upgrade --major-versions; flutter-dart-fix'
...
alias flutter-firebase-init='firebase login; flutter-update-firebase; flutterfire configure;'
alias flutter-firebase-configure='flutterfire configure;'
alias flutter-update-firebase='dart pub global activate flutterfire_cli;'
