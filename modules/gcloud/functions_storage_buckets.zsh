...
function gcloud-storage-buckets-create() {
    ...
    _log-info "🔹 Creating Storage Buckets $GS_BUCKET_STATIC, $GS_BUCKET_NAME, and $GCP_PROJECT_ID-cloudbuild-artifacts"
...
function gcloud-storage-buckets-delete() {
    ...
    _log-info "🔹 Deleting the Storage Buckets $GS_BUCKET_STATIC, $GS_BUCKET_NAME, and $GCP_PROJECT_ID-cloudbuild-artifacts..."
...
function gcloud-storage-buckets-sync-static() {
    ...
    _log-info "🔹 Syncing static files to the storage bucket $GS_BUCKET_STATIC..."
...
function gcloud-storage-buckets-set-public-read() {
    ...
    _log-info "🔹 Setting public read permissions to the Storage Buckets $GS_BUCKET_STATIC and $GS_BUCKET_NAME..."
...
function gcloud-storage-buckets-set-cross-origin() {
    ...
    _log-info "🔹 Setting cross-origin policy to the Storage Buckets $GS_BUCKET_STATIC and $GS_BUCKET_NAME..."
