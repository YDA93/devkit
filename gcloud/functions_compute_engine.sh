...
function gcloud_compute_engine_ipv4_create {
    ...
    confirm_action "Are you sure you want to create a new static IPv4 address?" "$@" || return 1
...
function gcloud_compute_engine_ipv4_delete() {
    ...
    confirm_action "Are you sure you want to delete the static IPv4 address?" "$@" || return 1
...
function gcloud_compute_engine_ssl_certificate_create() {
    ...
    confirm_action "Are you sure you want to create a new SSL certificate?" "$@" || return 1
...
function gcloud_compute_engine_ssl_certificate_delete() {
    ...
    confirm_action "Are you sure you want to delete the SSL certificate?" "$@" || return 1
...
function gcloud_compute_engine_network_endpoint_group_create() {
    ...
    confirm_action "Are you sure you want to create a new Network Endpoint Group?" "$@" || return 1
...
function gcloud_compute_engine_network_endpoint_group_delete() {
    ...
    confirm_action "Are you sure you want to delete the Network Endpoint Group?" "$@" || return 1
...
function gcloud_compute_engine_backend_service_create() {
    ...
    confirm_action "Are you sure you want to create a new backend service and attach the Network Endpoint Group (NEG)?" "$@" || return 1
...
function gcloud_compute_engine_backend_service_delete() {
    ...
    confirm_action "Are you sure you want to remove the Network Endpoint Group (NEG) from the backend service and delete the backend service?" "$@" || return 1
...
function gcloud_compute_engine_url_map_create() {
    ...
    confirm_action "Are you sure you want to create a new URL map?" "$@" || return 1
...
function gcloud_compute_engine_url_map_delete() {
    ...
    confirm_action "Are you sure you want to delete the URL map?" "$@" || return 1
...
function gcloud_compute_engine_target_https_proxy_and_attach_ssl_certificate() {
    ...
    confirm_action "Are you sure you want to create a new HTTPS target proxy and attach the SSL certificate?" "$@" || return 1
...
function gcloud_compute_engine_target_https_proxy_delete() {
    ...
    confirm_action "Are you sure you want to delete the Target HTTPS Proxy?" "$@" || return 1
...
function gcloud_compute_engine_global_forwarding_rule_create() {
    ...
    confirm_action "Are you sure you want to create a new Global Forwarding Rule?" "$@" || return 1
...
function gcloud_compute_engine_global_forwarding_rule_delete() {
    ...
    confirm_action "Are you sure you want to delete the Global Forwarding Rule?" "$@" || return 1
...
function gcloud_compute_engine_cloud_load_balancer_setup() {
    ...
    confirm_action "Are you sure you want to set up the Cloud Load Balancer?" "$@" || return 1
    ...
    confirm_action "Please confirm that you have pointed your domain to the Load Balancer's IP Address." "$@" || return 1
...
function gcloud_compute_engine_cloud_load_balancer_teardown() {
    ...
    confirm_action "Are you sure you want to teardown the Cloud Load Balancer?" "$@" || return 1
