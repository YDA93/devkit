...
function gcloud_run_build_image() {
    ...
    confirm_action "Are you sure you want to build the Docker image and deploy the service to Cloud Run?" "$@" || return 1
...
function gcloud_run_deploy_initial() {
    ...
    confirm_action "Are you sure you want to deploy the service to Cloud Run for the first time?" "$@" || return 1
...
function gcloud_run_deploy_latest() {
    ...
    confirm_action "Are you sure you want to redeploy the service to Cloud Run?" "$@" || return 1
...
function gcloud_run_set_service_urls_env() {
    ...
    confirm_action "Are you sure you want to update the service URLs environment variable in Cloud Run?" "$@" || return 1
...
function gcloud_run_build_and_deploy_initial() {
    ...
    confirm_action "Are you sure you want to build the Docker image and deploy the service to Cloud Run for the first time?" "$@" || return 1
...
function gcloud_run_build_and_deploy_latest() {
    ...
    confirm_action "Are you sure you want to build the Docker image and redeploy the service to Cloud Run?" "$@" || return 1
...
function gcloud_run_service_delete() {
    ...
    confirm_action "Are you sure you want to delete the Cloud Run service and job?" "$@" || return 1
