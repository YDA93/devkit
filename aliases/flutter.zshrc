...
alias flutter-update-icon='flutter pub run flutter_launcher_icons:main'
alias flutter-update-splash='flutter pub run flutter_native_splash:remove && flutter pub run flutter_native_splash:create'
...
alias flutter-clean-deep='flutter-update-fontawesome && flutter-ios-reinstall-podfile && flutter-clean && flutter-update-icon && flutter-update-splash && flutter-build-runner'